...
2. Модуль `abs_base_api.py` содержит код абстрактного класса ***BaseAPI(ABC)*** для работы с API сервисами с вакансиями. Абстрактный класс содержит описание 2-х методов:
